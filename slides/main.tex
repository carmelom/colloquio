  ...
  \begin{figure}
    ...
    \begin{columns}
     ...
     \begin{column}{.6\textwidth}
      \begin{figure}
       \fbox{
       \includegraphics[width=.7\columnwidth]{files/Photon_dispersion.pdf}}
      \end{figure}
...
% \begin{figure}
% \includegraphics[width=\textwidth]{files/Shapevspump-and-Spectra.png}
% \end{figure}
\begin{columns}[t]
 \begin{column}{.5\textwidth}
  \begin{figure}
...
\begin{flalign*}
 ...
 \\
 i \partial_t\, \bvec{\delta\psi} = \mathcal{L}\bog \cdot \bvec{\delta\psi} + \bvec{f_{ext}}
\end{flalign*}
